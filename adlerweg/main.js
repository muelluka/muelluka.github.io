...
map.on("zoomend moveend", function (evt) {
    ...
    let url =`https://secure.geonames.org/wikipediaBoundingBoxJSON?north=${ext.north}&south=${ext.south}&east=${ext.east}&west=${ext.west}&username=muelluka&lang=de&maxRows=30`;
    console.log(url);
